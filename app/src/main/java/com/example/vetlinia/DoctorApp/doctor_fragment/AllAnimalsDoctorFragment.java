...
import com.example.vetlinia.databinding.DoctorAllAnimalsFragmentBinding;
...
public class AllAnimalsDoctorFragment extends Fragment {
    DoctorAllAnimalsFragmentBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = DoctorAllAnimalsFragmentBinding.inflate(getLayoutInflater());
